...
exports.submitTrialFeedback = exports.validateFeedbackToken = exports.sendDailyFeedbackRequests = exports.sendTrialBranchNotification = void 0;
...
// ============================================================================
async function sendEmailViaGraph(accessToken, organizerUserId, to, subject, htmlBody) {
...
// ============================================================================
exports.sendTrialBranchNotification = (0, https_1.onCall)({
    cors: true,
    region: 'europe-west2',
    ...
    const { candidateName, 
    // branchName, // unused 
    branchEmail, scheduledDate, duration, jobTitle } = request.data;
    try {
        ...
        if (!clientId || !clientSecret || !tenantId || !organizerUserId) {
            throw new https_1.HttpsError('failed-precondition', 'Email not configured');
        }
      ...
      `;
        await sendEmailViaGraph(accessToken, organizerUserId, branchEmail, `Trial Booking: ${candidateName} - ${formattedDate}`, htmlBody);
...
// ============================================================================
exports.sendDailyFeedbackRequests = (0, scheduler_1.onSchedule)({
    ...
    try {
        ...
        `;
            await sendEmailViaGraph(accessToken, organizerUserId, branch.email, `Feedback Request: ${trial.candidateName}`, htmlBody);
...
// ============================================================================
exports.validateFeedbackToken = (0, https_1.onCall)({
    cors: true,
    region: 'europe-west2',
}, async (request) => {
...
// ============================================================================
exports.submitTrialFeedback = (0, https_1.onCall)({
    cors: true,
    region: 'europe-west2',
}, async (request) => {
    ...
    const tokenData = tokenDoc.data();
    if (tokenData.used) {
        throw new https_1.HttpsError('already-exists', 'Feedback already submitted');
    }
    if (tokenData.expiresAt.toDate() < new Date()) {
...
//# sourceMappingURL=trialNotifications.js.map